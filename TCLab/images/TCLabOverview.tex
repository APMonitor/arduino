...
\begin{tikzpicture}[auto,thick,node distance = 1cm]
    %\draw[step=1cm,gray,very thin] (0,0) grid (16,9);
  	...
  	\draw (5,8) node[block] (top) {\large\bf IPython/Jupyter notebooks};
  	\draw (5,6) node[block] (mid) {\large\bf TCLab};
  	\draw (5,3) node[block] (bot) {\large\bf TCLab Firmware};
	...
	\draw (2.5,0.25) node[right] {Arduino/TCLab Shield};	

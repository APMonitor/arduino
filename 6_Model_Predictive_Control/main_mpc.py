...
# Temperature (K)
Tsp = np.ones(loops) * 300.0 # set point
...
desiredTemp = (80.0-32.0) * 5.0/9.0 + 273.15
sphi = desiredTemp + 0.1
splo = desiredTemp - 0.1
...
try:
    ...
    for i in range(loops-1):
            ...
            if automatic:
                ...
                if i==1:
                    Tsp_new = (120.0-32.0) * 5.0/9.0 + 273.15
                if i==180:
                    Tsp_new = (100.0-32.0) * 5.0/9.0 + 273.15
                # change in setpoint
                if Tsp_new != Tsp_old:

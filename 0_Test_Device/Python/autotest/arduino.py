...
#            self.s.open()
        self.sr = self.s
        # First transistor and sensor
        self.tempInPin = 0
        self.voltOutPin = 3
        # Second transistor and sensor (for MIMO)
        self.tempInPin2 = 2
        self.voltOutPin2 = 5
        # LED 
        self.ledPin = 9
    ...
    def initPlots(self):
        ...
        # time, v_out 1, temp 1, temp setpoint 1
    ...
    def readTemp(self):
        '''
        Reads temperature in K from first temperature sensor
        '''
        ...
        self.analogWrite(self.ledPin,led_level)      
        return degK
    
    def readTemp2(self):
        '''
        Reads temperature in K from second temperature sensor
        '''
    ...
    def writeVoltage(self,mV):
        '''
        Outputs desired voltage in millivolts to the first transistor
        '''
    ...
    def writeVoltage2(self,mV):
        '''
        Outputs desired voltage in millivolts to the second transistor
        '''
